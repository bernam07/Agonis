...
export default function Footer({ onNavigate }: { onNavigate: (tab: string) => void }) {
  return (
    <footer className="mt-16 py-8 border-t border-zinc-800/50 text-center">
      ...
      <div className="flex justify-center gap-6 text-xs font-bold text-zinc-600">
        <button 
