  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 font-sans selection:bg-indigo-500/30 flex flex-col transition-colors duration-300">
      ...
      <main className="flex-1 flex flex-col items-center justify-center text-center px-6 py-20">
        ...
        <p className="text-zinc-600 dark:text-zinc-400 text-lg md:text-xl font-medium max-w-2xl mb-10 leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto w-full mt-32 text-left">
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-8 rounded-3xl">
            ...
            <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-2">Build your Library</h3>
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-8 rounded-3xl">
            ...
            <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-2">Rate & Review</h3>
            <p className="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed">
          ...
          <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-8 rounded-3xl">
            ...
            <h3 className="text-xl font-bold text-zinc-900 dark:text-white mb-2">Social Feed</h3>
            <p className="text-zinc-600 dark:text-zinc-400 text-sm leading-relaxed">
