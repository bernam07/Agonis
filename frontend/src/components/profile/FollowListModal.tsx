        ...
        <div className="max-h-96 overflow-y-auto custom-scrollbar">
          {data.users.length === 0 ? (
            ...
            data.users.map((u: any) => (
              <div key={u.id} onClick={() => { onClose(); if (onUserClick) onUserClick(u.id); }} className="flex items-center gap-3 p-4 border-b border-zinc-800/50 hover:bg-zinc-800 transition-colors cursor-pointer">
